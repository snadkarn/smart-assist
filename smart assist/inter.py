...
#img = cv2.VideoCapture('http://100.87.31.85:8080/video')
...
button2 = tk.Button(m, text='switch flip',font=("Courier", 30),command=func2) 

button2.pack(padx=50, pady=10, side=tk.LEFT)

button1 = tk.Button(m, text='movement',font=("Courier", 30),command=func1)
#button1.invoke() 

button1.pack(padx=50, pady=10, side=tk.LEFT)

button3 = tk.Button(m, text='distress message',font=("Courier", 30),command=func3) 
